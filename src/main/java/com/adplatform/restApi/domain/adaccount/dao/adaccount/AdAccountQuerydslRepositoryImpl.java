...
public class AdAccountQuerydslRepositoryImpl implements AdAccountQuerydslRepository {
    ...
    public Page<AdAccountDto.Response.ForAgencySearch> searchForAgency(Pageable pageable, AdAccountDto.Request.ForAgencySearch request, Integer userId) {
        SearchForAgencySubQueries subQueries = this.getSearchForAgencySubQueries();

        List<AdAccountDto.Response.ForAgencySearch> content = this.getSearchForAgencyQuery(pageable, request, userId, subQueries)
                ...
                .transform(GroupBy.groupBy(adAccount.id)
                        .list(new QAdAccountDto_Response_ForAgencySearch(
                                ...
                                new QWalletDto_Response_WalletSpend(
                                        ...
                                        subQueries.getTodaySpendQuery(),
                                        subQueries.getYesterdaySpendQuery(),
                                        subQueries.getMonthSpendQuery()
                                ),
    ...
    @Override
    public List<AdAccountDto.Response.ForAgencySearch> searchForAgency(AdAccountDto.Request.ForAgencySearch request, Integer userId) {
        SearchForAgencySubQueries subQueries = this.getSearchForAgencySubQueries();

        return this.getSearchForAgencyQuery(null, request, userId, subQueries)
                .transform(GroupBy.groupBy(adAccount.id)
                        .list(new QAdAccountDto_Response_ForAgencySearch(
                                adAccount.id,
                                adAccount.name,
    ...
    private JPAQuery<Tuple> getSearchForAgencyQuery(
            Pageable pageable,
            AdAccountDto.Request.ForAgencySearch request,
            Integer userId,
            SearchForAgencySubQueries subQueries) {
